package io.eric.vendorapi.configuration;
...
public class RabbitMQConfiguration {
	...
	@Bean
	public Queue rmeQueue() {
		return new Queue(RabbitMQConstants.RME_QUEUE_NAME, false);
	}
	@Bean
	...
	@Bean
	public Binding bindRME(Queue rmeQueue, DirectExchange directExchange){
		return BindingBuilder
				.bind(rmeQueue)
				.to(directExchange)
				.with(RabbitMQConstants.RME_ROUTING_KEY);
	}
